...
@Slf4j
@Service
public class CustomerMessageIml implements CustomerMessageListener {

    private  final CustomerRepository customerRepository;
    private final OrderDataMapper orderDataMapper;

    public CustomerMessageIml(CustomerRepository customerRepository, OrderDataMapper orderDataMapper) {
    ...
    public void customerCreated(CustomerModel customerModel) {
        ...
        if (customer == null){
            throw new OrderDomainException("Customer could not created");
        }
