...
class OrderApplicationServiceImpl implements OrderApplicationService {
    ...
    OrderApplicationServiceImpl(OrderCreateCommandHandler createCommandHandler, OrderTrackQueryHandler orderTrackQueryHandler) {
        this.orderCreateCommandHandler = createCommandHandler;
